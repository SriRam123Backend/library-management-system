...
/**
 * Servlet implementation class ToBeReturnBooks
 */
@WebServlet("/filter/ToBeReturnBooks")
public class ToBeReturnBooks extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ToBeReturnBooks() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{
			if(books.getUStatus().toString().equals("NOTRETURNED"))
			{
				...
				book.put("isFined",books.getFined());
